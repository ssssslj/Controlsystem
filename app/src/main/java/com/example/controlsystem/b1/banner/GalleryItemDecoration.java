...
public class GalleryItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public int mLeftPageVisibleWidth = 150; // 中间页面左右两边的页面可见部分宽度
    ...
    private void onSetHorizontalParams(ViewGroup parent, View itemView, int position, int itemCount) {
        int itemNewWidth = OsUtil.getScreenWidth() - OsUtil.dpToPx(4 * mPageMargin + 2 * mLeftPageVisibleWidth);
        Log.i("111111111111111",OsUtil.getScreenWidth()+"");
        Log.i("111111111111111",parent.getWidth()+"");
        ...
        Log.i("1111111111111222",itemNewWidth+"");
    }
